  ...
  run: async (bot, message, args) => {
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
      ...
      let moneyEmbed = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(`❌ You need atleast 100 Dollar in your wallet to rob someone`);
      ...
      if (targetuser < random) {
        ...
        let embed = new MessageEmbed()
          .setDescription(`✅ You robbed ${user.user.username} and got away with ${random} Dollar :dollar:`)
          .setColor("RANDOM")
