    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'nikes') {
            ...
            let embed2 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`✅ Sold Fresh Nikes For 600 Dollar :dollar:`);
            ...
            let embed4= new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`✅ Sold a Car For 800 Dollar :dollar:`);
            ...
            let sembed3 = new MessageEmbed()
                .setColor("RANDOM")
                .setDescription(`✅ Sold a Mansion For 1200 Dollar :dollar:`);
