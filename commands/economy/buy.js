...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    let Embed = new MessageEmbed()
      .setColor("RANDOM")
      .setDescription(`❌ You need 200 Dollar to purchase Bronze VIP`);
    ...
    if (args.join(" ").toLocaleLowerCase() == "bronze") {
      ...
      let Embed2 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(
          `:wind_chime: Purchased Bronze VIP For 200 Dollar :dollar:`
        );
      ...
      let Embed3 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(`❌ You need 600 Dollar to purchase some Nikes`);
      ...
      let Embed4 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(
          `:athletic_shoe: Purchased Fresh Nikes For 600 Dollar :dollar:`
        );
      ...
      let Embed5 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(`❌ You need 800 Dollar to purchase a new car`);
      ...
      let Embed6 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(
          `:race_car: Purchased A New Car For 800 Dollar :dollar:`
        );
      ...
      let Embed7 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(`❌ You need 1200 Dollar to purchase a Mansion`);
      ...
      let Embed8 = new MessageEmbed()
        .setColor("RANDOM")
        .setDescription(
          `:house_with_garden: Purchased A Mansion For 1200 Dollar :dollar:`
        );
